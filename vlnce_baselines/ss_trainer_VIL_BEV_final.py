...
from .ss_trainer_BEV import BEVTrainer
...
@baseline_registry.register_trainer(name="VIL-BEV-Trainer-final")
    ...
    def _initialize_policy(
        ...
        if load_from_ckpt:
            ...
            if 'module' in list(ckpt_dict['state_dict'].keys())[0] and self.config.GPU_NUMBERS == 1:
                ...
                self.policy.load_state_dict(ckpt_dict["state_dict"], strict=False)
            if config.IL.is_requeue and "optim_state" in ckpt_dict:
        ...
        for idx in range(start_iter, total_iter, log_every):
            ...
            try:
                ...
                if self.local_rank < 1:
                    ...
                    if cur_iter > 4000: # TODO: This should be deleted in the final version. This is to save space for useful ckpts and for faster evaluation.
        ...
        for stepk in range(self.max_len):
            ...
            if mode == 'eval':
                ...
                for i in range(self.envs.num_envs):
                    ...
                    csv_path = "eval_vilbev_metrics.csv"
                    row = {"ep_id": ep_id}
                    row.update(metric)
