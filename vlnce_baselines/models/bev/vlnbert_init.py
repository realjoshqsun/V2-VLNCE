...
def get_vlnbert_models(config=None):
    ...
    from vlnce_baselines.models.bev.vilmodel_cmt import GlocalTextPathNavCMT
    ...
    vis_config.glocal_fuse = 'dynamic'
